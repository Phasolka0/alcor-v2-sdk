...
import {BigintIsh, FeeAmount, NEGATIVE_ONE, ONE, Q128, TICK_SPACINGS, ZERO} from "../internalConstants";
...
export class Pool {
	...
	public getInputAmount(
		...
		const {
			amountA,
			amountB
		} = this.swap(zeroForOne, JSBI.multiply(outputAmount.quotient, NEGATIVE_ONE), sqrtPriceLimitX64);
